...
class navBar {
	constructor(theme) {
		...
		this.src = `<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<div class="d-flex" id="items-list-right"></divc>
						</div>
					</div>`;
	}
	...
	addItem(role, properties, position="left", classes="", id="") {
		...
		if (role === "home") {
			...
			let navTitle = document.getElementById("navbar-title");
			navTitle.innerHTML = `<img src="${properties}" id="${id}" alt="Navbar Image" width="30" height="24" class="d-inline-block align-text-top">`
								+ navTitle.innerHTML;
		} else if (role === "link") {
